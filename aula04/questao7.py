...
quant_atual = int(input('Informe a quantidade atual em estoque: '))
quant_max = int(input('Informe a quantidade máxima em estoque: '))
quant_min = int(input('Informe a quantidade mínima em estoque: '))
